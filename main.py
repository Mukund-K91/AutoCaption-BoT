...
try: api_id = os.environ.get("api_id", None)
except Exception as api_id: print(f"⚠️ App ID Invalid {api_id}")
...
AutoCaptionBot = pyrogram.Client(name="AutoCaptionBot", api_id=api_id, api_hash=api_hash, bot_token=bot_token)
start_message = """
<b>👋Hello {}</b>
